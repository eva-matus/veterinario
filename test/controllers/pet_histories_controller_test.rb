...
class PetHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pet_history" do
    assert_difference('PetHistory.count') do
      post pet_histories_url, params: { pet_history: { diagnostic: @pet_history.diagnostic, height: @pet_history.height, pet_id: @pet_history.pet_id, weight: @pet_history.weight } }
    end
  ...
  test "should update pet_history" do
    patch pet_history_url(@pet_history), params: { pet_history: { diagnostic: @pet_history.diagnostic, height: @pet_history.height, pet_id: @pet_history.pet_id, weight: @pet_history.weight } }
